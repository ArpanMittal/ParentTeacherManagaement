...
class DateListAdapterExtend extends DateListAdapter {
    private Context context;
    private ArrayList<DateModel> dateModelList;
    private static LinearLayout previousClickItem;
    private static  boolean isPreviousCurrent;
    ...
    public DateListAdapterExtend(Context context, ArrayList<DateModel> dateModelList) {
        super(context,dateModelList);
        ...
        public void setDates(final DateModel model) {
            ...
            ll_sub_parrent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(previousClickItem != null){
                       if(isPreviousCurrent)
                            previousClickItem.setBackgroundColor(context.getResources().getColor(R.color.colorPrimaryDark));
                        else
                            previousClickItem.setBackgroundColor(context.getResources().getColor(R.color.white));
                    }
                    if (model.getDates().getDate() == date_current_date.getDate() && model.getDates().getMonth() == date_current_date.getMonth() && model.getDates().getYear() == date_current_date.getYear())
                    ...
                    previousClickItem = (LinearLayout)v.findViewById(R.id.ll_sub_parrent);
                    previousClickItem.setBackgroundColor(context.getResources().getColor(R.color.colorPrimary));

//                    new SharedPrefrence().savePreviousLayoutDetails(context, isPreviousCurrent, previousClickItem);
