...
import static com.eurovisionedusolutions.android.rackup.R.layout.calendar;

/**
 * Creates a dialog for picking the year and month.
 */

public class CustomYearMonthPickerDialog implements Dialog.OnClickListener {
    /**
     ...
     */
    public CustomYearMonthPickerDialog(Context context, OnDateSetListener onDateSetListener) {
     ...
     */
    public CustomYearMonthPickerDialog(Context context, OnDateSetListener onDateSetListener, int theme) {
     ...
     */
    public CustomYearMonthPickerDialog(Context context, OnDateSetListener onDateSetListener, int theme, int titleTextColor) {
        mContext = context;
    ...
    public CustomYearMonthPickerDialog(Context context, OnDateSetListener onDateSetListener, int theme, int titleTextColor, int month, int year) {
        mContext = context;
        mOnDateSetListener = onDateSetListener;
        mTheme = theme;
        mTextTitleColor = titleTextColor;
        ...
        MIN_YEAR = calendar.get(Calendar.YEAR) - 1 ;
