 ...
 */
public class UserContract_Video_Details {
    ...
    public static final String PATH_USER_DETAIL = "VideoDetails";
    ...
    public static final class UserDetailEntry implements BaseColumns {
        ...
        public static final String TABLE_NAME="VideoDetail";

        // user detail column name


        public static final String F_key = "foreign_key";
